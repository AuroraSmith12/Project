...
char auth[] = "8480011324e4";

//----------WIFI连接配置----------
const char* ssid     = "Mi 11 Lite";       // 连接WiFi名（此处使用XXX为示例）                                   
const char* password = "1421040608";          // 连接WiFi密码（此处使用12345678为示例）
                                            // 请将您需要连接的WiFi密码填入引号中
//----------天气API配置----------
...
// 心知天气HTTP请求所需信息
String reqUserKey = "S3usbArcoIh_vRGc5";   // 私钥
